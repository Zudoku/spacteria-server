...
4	Capsatriene Syringe gun	Shoot out effective \nantibiotics in longer range	3	f	4	t	1	20	3	[\n    {\n        "id": 4,\n        "value": 150\n    },\n    {\n        "id": 5,\n        "value": 2\n    },\n    {\n        "id": 2,\n        "value": 2\n    },\n    {\n        "id": 3,\n        "value": 2\n    },\n    {\n        "id": 6,\n        "value": 20\n    },\n    {\n        "id": 10,\n        "value": 9\n    }\n]
5	Cell remains	is this SFW?	8	t	0	t	0	1	41	[]
...
18	Gas mask	It seems to be pretty old.\nMaybe the filter is used...	0	t	2	t	0	5	37	[\n    {\n        "id": 1,\n        "value": 15\n    }\n]
19	Shoulder armor	Heavy but bulky.	2	f	1	t	0	5	28	[\n    {\n        "id": 3,\n        "value": 1\n    },\n    {\n        "id": 6,\n        "value": -10\n    }\n]
20	Zon-Zon Boots	It seems to be enchanted to\ngive speed.	5	f	4	t	1	5	19	[\n    { "id": 6, "value": 20}\n]
21	Optical fibre Suit	Its clanky but gives some shield.	4	f	3	t	0	5	21	[\n    { "id": 1, "value": 5}\n]
22	Optical fibre Pants	It looks uncomfortable.	1	f	2	t	0	5	25	[\n    { "id": 2, "value": 1}\n]
\.
...
SELECT pg_catalog.setval('gameitem_uniqueid_seq', 22, true);
