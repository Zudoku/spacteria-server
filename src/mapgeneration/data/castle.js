module.exports = {
  ...
  tilesize: 7,
  tiles: [
        { name: 'bridge', symmetry: 'I', id: 3 },
        { name: 'ground', symmetry: 'X', id: 21 },
        { name: 'river', symmetry: 'I', id: 2 },
        { name: 'riverturn', symmetry: 'L', id: 2 },
        { name: 'road', symmetry: 'I', id: 22 },
        { name: 'roadturn', symmetry: 'L', id:22 },
        { name: 't', symmetry: 'T', id: 22 },
        { name: 'tower', symmetry: 'L', id: 4 },
        { name: 'wall', symmetry: 'I', id: 4 },
        { name: 'wallriver', symmetry: 'I', id: 4 },
        { name: 'wallroad', symmetry: 'I', id: 4 },
  ],
  neighbors: [
